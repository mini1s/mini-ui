...
export function StatusPage({
    ...
    return (
        <div className="min-h-[50vh] flex-1 flex flex-col items-center justify-center p-16 ">
            <div className="flex items-center justify-center gap-16 text-gray-80 max-w-5xl">
                ...
                <div className="flex flex-col gap-4">
                    {semititle && (
                        <h2 className="text-2xl font-space-grotesk font-bold text-gray-600">
                            {semititle}
                        </h2>
                    )}
                    {title && (
                        <h1 className="text-5xl font-space-grotesk font-bold">
                            {title}
                        </h1>
                    )}
                        ...
                        <div className="flex gap-4 mt-6">
                            {links.map((link, i) => (
                                <Link
                                    key={i}
                                    href={link.to}
                                    className={`button ${link.color ?? "gray"} font-rubik`}
                                >
                                    {link.text}
                                </Link>
                            ))}
